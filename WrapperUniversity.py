...
"""
Created on Mon Apr  8 11:59:14 2019

@author: GW778XR
"""

"""
Thanks to the webscraping technique, data is more than accessible.
This technique (and the powerful Beautiful Soup package) allows to 
automatically extract large amounts of data from a website.
This exercice shows how it can be easy to get a list of Universities from an
up-to-date database maintained by Klaus Förster - univ.cc.
"""
...
#Append all url from Worl and USA together
...
all_uni.to_excel("list of all university in the world.xlsx", index=False)